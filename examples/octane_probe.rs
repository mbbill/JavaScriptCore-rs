...
fn main() {
    ...
    if let Some(benchmark) = benchmark {
        ...
        let config = octane_execution_config(
            mode,
            failure_policy,
            dispatch_steps,
            disable_baseline_generated_executor,
...
fn generated_direct_call_generated_entry_policy(
    disable_generated_direct_call_generated_entry: bool,
) -> GeneratedDirectCallGeneratedEntryPolicy {
    if disable_generated_direct_call_generated_entry {
        GeneratedDirectCallGeneratedEntryPolicy::Disabled
    } else {
...
fn print_tiering_summary(vm: &Vm) {
    ...
    let baseline_generated_invalidation_summary =
    ...
    let _ = writeln!(
        ...
        baseline_generated_invalidation_summary.total,
        baseline_generated_invalidation_summary.accepted,
        baseline_generated_invalidation_summary.no_matching_artifact,
        baseline_generated_invalidation_summary.bytecode_snapshot_mismatch,
        baseline_generated_invalidation_summary.already_invalidated,
        baseline_generated_invalidation_summary.explicit,
        baseline_generated_invalidation_summary.property_load_probe_miss,
        baseline_generated_invalidation_summary.guarded_property_load_probe_miss,
        baseline_generated_invalidation_summary.property_load_guard_watchpoint_invalidation,
...
fn print_benchmark_tiering_summary(benchmark: &OctaneBenchmarkExecutionReport) {
    ...
    let _ = writeln!(
        ...
        summary.baseline_generated_code_invalidations,
        summary.baseline_generated_code_invalidation_summary.accepted,
        summary
        ...
        summary
            .baseline_generated_code_invalidation_summary
            .already_invalidated,
        summary.baseline_generated_code_invalidation_summary.explicit,
        summary
            .baseline_generated_code_invalidation_summary
