...
pub(crate) use emitter::P14X86_64BaselineBackedgeSafepointAuthority;
pub use emitter::{
...
pub use ic::{
    ...
    GeneratedGuardedPropertyLoadProbeResult, GeneratedPropertyLoadDestinationRootSync,
    GeneratedPropertyLoadProbeHit, GeneratedPropertyLoadProbeMiss,
    GeneratedPropertyLoadProbeMissReason, GeneratedPropertyLoadProbeRequest,
    GeneratedPropertyLoadProbeResult, GeneratedPropertyStoreProbeHit,
    GeneratedPropertyStoreProbeMiss, GeneratedPropertyStoreProbeMissReason,
    GeneratedPropertyStoreProbeRequest, GeneratedPropertyStoreProbeResult,
    InlineCacheBarrierMetadata, InlineCacheBarrierTarget, InlineCacheCaseClassification,
    InlineCacheDispatch, InlineCacheFallbackSemantics, InlineCacheInvalidation,
    InlineCacheInvalidationReason, InlineCacheKind, InlineCacheMissHandoffDescriptor,
    InlineCacheMissKind, InlineCacheRegistryMutationAuthority, InlineCacheSchemaOwner,
    InlineCacheSchemaRegistry, InlineCacheSemanticClass, InlineCacheSemanticSummary,
    InlineCacheSlot, InlineCacheSlotBuilder, InlineCacheSlotId, InlineCacheState, InlineCacheStub,
    InlineCacheStubId, InlineCacheStubKind, InlineCacheValidationError, LinkedCallKind,
    ...
    PropertyLoadDataOnlyOwnLoadEffects, PropertyLoadExitEffect, PropertyLoadGuardChainCertificate,
    PropertyLoadGuardChainEntry, PropertyLoadGuardChainEntryProof, PropertyLoadGuardChainOutcome,
