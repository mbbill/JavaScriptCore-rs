...
pub struct OctaneTieringSummary {
    ...
    pub baseline_entry_auto_materialization_records: Vec<BaselineEntryAutoMaterializationRecord>,
...
impl OctaneTieringSummary {
    fn from_vm(vm: &Vm) -> Self {
        ...
        Self {
            ...
            baseline_entry_auto_materializations: tiering
                ...
                .len(),
            baseline_entry_auto_materialization_records: tiering
                .baseline_entry_auto_materializations()
                .to_vec(),
    ...
    fn delta_since(self, start: Self) -> Self {
        ...
        let baseline_entry_auto_materialization_records = self
            ...
            .iter()
            .skip(start.baseline_entry_auto_materialization_records.len())
            .cloned()
            .collect();
...
mod tests {
    ...
    use crate::vm::{
        ...
        BaselineEntryAutoNativeMaterializationOutcome, BaselineGeneratedCodeInstallStage,
...
"
    ...
    fn octane_tiering_summary_delta_preserves_detailed_rootless_telemetry() {
        ...
        let start_auto_record = BaselineEntryAutoMaterializationRecord {
            ordinal: 1,
            owner,
        ...
        let current_auto_record = BaselineEntryAutoMaterializationRecord {
            ordinal: 2,
            owner: second_owner,
            requested_tier: JitType::Baseline,
            native:
            ...
            native_detail: None,
            generated: Some(BaselineEntryAutoGeneratedMaterializationOutcome::Installed),
            generated_detail: Some(BaselineEntryAutoGeneratedMaterializationDetail::Eligibility {
                stage: BaselineGeneratedCodeInstallStage::PropertyHandoffPlan,
                error: JitPlanValidationError::BaselineGeneratedPropertyHandoffPlanMalformedBytecodeCache {
        ...
        let current = OctaneTieringSummary {
            ...
            baseline_entry_auto_materialization_records: vec![
                start_auto_record,
                current_auto_record.clone(),
            ],
        ...
        assert_eq!(
            delta.baseline_entry_auto_materialization_records,
            vec![current_auto_record]
        );
